...
// LoadStagingSnapshot loads a snapshot from .gomion/snapshots/{id}.json
...
// Archive moves snapshots older than daysOld to .gomion/.archive/snapshots/
...
// ArchiveSnapshots moves snapshots older than daysOld to .gomion/.archive/snapshots/
