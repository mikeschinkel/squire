...
func NewFileDispositionTree(fileSource *FileSource, dispositionFunc func(dt.RelFilepath) gompkg.FileDisposition) (m FileDispositionTree) {
	...
	tree := bubbletree.NewTree[bubbletree.File](nodes, &bubbletree.TreeArgs[bubbletree.File]{
		NodeProvider: NewFileDispositionNodeProvider(dispositionFunc),
	})
...
func NewEmptyFileDispositionTree(message string, width, height int, dispositionFn func(dt.RelFilepath) gompkg.FileDisposition) FileDispositionTree {
