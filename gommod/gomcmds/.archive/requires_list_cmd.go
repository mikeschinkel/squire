...
//			Required: false,
//			Default:  string(gompkg.TableOutputFormat),
...
//	*requiresListOpts.Format = string(gompkg.TableOutputFormat)
//
...
//	var format gompkg.OutputFormat
//
//	config = c.Config.(*gompkg.Config)
//
//	// Convert and validate format
//	format = gompkg.OutputFormat(*requiresListOpts.Format)
//	if !format.IsValid() {
...
//func (c *RequiresListCmd) outputModules(modules gompkg.Modules, format gompkg.OutputFormat, config *gompkg.Config) (err error) {
//	var buf bytes.Buffer
//
//	switch format {
//	case gompkg.JSONOutputFormat:
//		config.Writer.Printf("%s\n", modules.JSON())
//	case gompkg.CSVOutputFormat:
//		err = modules.CSV(&buf)
//		if err != nil {
