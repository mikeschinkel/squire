...
// Save saves the commit candidate to .squire/candidates/{id}.json or archive
...
// LoadCommitCandidate loads a commit candidate from .squire/candidates/{id}.json
...
// Archive marks a candidate as archived and moves it to .squire/.archive/candidates/
...
// ArchiveCandidate marks a candidate as archived and moves it to .squire/.archive/candidates/
