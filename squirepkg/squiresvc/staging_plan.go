...
// Save saves the staging plan to .squire/plans/{id}.json
...
// LoadStagingPlan loads a staging plan from .squire/plans/{id}.json
...
// ListStagingPlans lists all staging plans in .squire/plans/
...
// DeleteStagingPlan deletes a staging plan from .squire/plans/{id}.json
