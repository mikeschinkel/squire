...
type APIDiffDirsOptions struct {
...
func APIDiffDirs(oldDir, newDir dt.DirPath, opts APIDiffDirsOptions) (r APIDiffReport, err error) {
	...
	r = APIDiff(oldMod, newMod, opts)
end:
	return r, err
}

func APIDiff(oldMod, newMod LoadedModule, opts APIDiffDirsOptions) APIDiffReport {
